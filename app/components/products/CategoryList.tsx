...
const CategoryList = () => {
  ...
  const { searchTerm, setSearchTerm, filteredItems } = useSearch(categories, [
    "name",
    "description",
  ]);
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto mb-8">
            ...
            <StatsCounter
              count={categories.reduce(
                (acc, cat) => acc + (cat.display_order || 0),
                0
              )}
              label="Products"
              ...
              {categories.length === 0 ? (
                <div className="space-y-4">
                  ...
                  <p className="text-gray-500">
                    No product categories are currently available. Please set up
                    the database first.
                  </p>
                  <div className="mt-6">
                    <a
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-gray-500">
                    No categories found matching your search criteria. Try
