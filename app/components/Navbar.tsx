...
const Navbar = ({ items, logoUrl, logoAlt, locale = defaultLocale }: NavbarProps) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20 sm:h-24">
          <div className="flex items-center">
            <Logo src={logoUrl} alt={logoAlt} locale={locale} />
          </div>
              ...
              item.isExternal ? (
                <a
                  ...
                  className={`block px-3 py-2 rounded-md text-base font-medium ${
                    isActive(item.path)
                      ? "bg-cyan-700 text-white border-s-4 border-cyan-300"
                      : "hover:bg-cyan-800"
                  }`}
