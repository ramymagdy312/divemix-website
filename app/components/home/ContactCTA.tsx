...
const ContactCTA = ({
  ...
  body = "Contact our team of experts for a consultation and discover how we can help optimize your operations",
  button = { label: "Contact Us Today", href: "/contact" },
}: ContactCTAProps) => {
  return (
    <section className="py-20 bg-gradient-to-br from-cyan-900 to-cyan-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-3xl font-bold mb-6">{title}</h2>
        <p className="text-xl text-cyan-100 mb-8 max-w-2xl mx-auto">{body}</p>
        <Link
          href={button.href}
