...
INSERT INTO products (name, description, category_id, images, features, is_active, display_order)
VALUES (
   'Mobile Compressors',
   'Designed for easy transport and mobility, these compressors deliver reliable performance in a compact form. Available with gasoline, diesel, or electric motors, they are perfect for field operations and on-site tasks, offering convenience and efficiency.',
   '29df263f-036c-456c-96a6-7c1ad093d13f',
    ARRAY['/img/products/L&W Compressors/Mobile/1.png','/img/products/L&W Compressors/Mobile/2.png','/img/products/L&W Compressors/Mobile/3.png']::text[],
    ARRAY[]::text[],
    true,
    1
);
...
VALUES (
   'Compact Compressors',
   'Ideal for small spaces, these compressors provide efficient performance without compromising power. With capacities from 230 to 570 liters per minute, they feature robust electric motors, ensuring versatility and efficiency.',
   '29df263f-036c-456c-96a6-7c1ad093d13f',
    ARRAY['/img/products/L&W Compressors/Compact/1.png','/img/products/L&W Compressors/Compact/2.png','/img/products/L&W Compressors/Compact/3.png']::text[],
    ARRAY[]::text[],
    true,
    2
);
-- وهكذا لباقي المنتجات
